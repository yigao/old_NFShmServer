...
void NFTea::encrypt(const char *key, const char *sIn, size_t iLength, std::vector<char> &buffer)
{
...
bool NFTea::decrypt(const char *key, const char *sIn, size_t iLength, std::vector<char> &buffer)
{
