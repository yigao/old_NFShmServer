...
--SnsServer DB代理服务器， 负责从数据库取数据
--ServerId = "15.100.9.1" 15是世界服务ID， 范围1-15
-- 100是区服务ID， 范围1-65536
-- 8是服务器类型ID， 必须跟serverType一样 范围1-255
-- 1服务器索引，范围1-255
SnsServer = {
    SnsServer_9_1 = {
        ServerName = "SnsServer_9_1",
        ServerType = 9,
        ServerId = "15.100.9.1",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
        IdleSleepUS = 1000,
        --LinkMode = "bus",
