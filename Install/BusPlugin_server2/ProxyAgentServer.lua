...
-- 1服务器索引，范围1-255
ProxyAgentServer = {
    ProxyAgentServer_13_2 = {
        ServerName = "ProxyAgentServer_13_2",
        ServerType = NF_ST_PROXY_AGENT_SERVER,
        ServerId = "15.100.13.2",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
        IdleSleepUS = 1000,
        LinkMode = "bus",
