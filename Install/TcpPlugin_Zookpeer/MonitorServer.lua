...
--MonitorServer Monitor代理服务器， 负责
--ServerId = "15.100.12.1" 15是世界服务ID， 范围1-15
-- 100是区服务ID， 范围1-65536
-- 12是服务器类型ID， 必须跟serverType一样 范围1-255
-- 1服务器索引，范围1-255
MonitorServer = {
    MonitorServer_12_1 = {
        ServerName = "MonitorServer_12_1",
        ServerType = NF_ST_MONITOR_SERVER,
        ServerId = "15.100.12.1",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
        IdleSleepUS = 1000,
        MaxConnectNum = 10000,
        WorkThreadNum = 5,
        ServerIp = "127.0.0.1",
