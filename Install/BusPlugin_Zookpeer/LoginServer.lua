...
--ServerId = "15.100.2.1" 15是世界服务ID， 范围1-15
-- 100是区服务ID， 范围1-65536
-- 2是服务器类型ID， 必须跟serverType一样 范围1-255
-- 1服务器索引，范围1-255
LoginServer = {
  LoginServer_2_1 = {
    ServerName = "LoginServer_2_1",
    ServerType = 2,
    ServerId = "15.100.2.1",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
    LinkMode = "bus",
  ...
  LoginServer_2_2 = {
    ServerName = "LoginServer_2_2",
    ServerType = 2,
    ServerId = "15.100.2.2",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
    LinkMode = "bus",
    BusLength = 20971520,     --20M共享内存
    RouteAgent = "15.100.6.1",
    IdleSleepUS = 1000,
  ...
  LoginServer_2_3 = {
    ServerName = "LoginServer_2_3",
    ServerType = 2,
    ServerId = "15.100.2.3",			--对每一个服务器来说都是唯一的， 应用程序需要通过这个ServerId才能知道需要加载的配置是他
    LinkMode = "bus",
    BusLength = 20971520,     --20M共享内存
    RouteAgent = "15.100.6.1",
    IdleSleepUS = 1000,
