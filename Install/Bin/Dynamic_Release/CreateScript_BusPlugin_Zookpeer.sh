...
do_work MasterServer 1.1.1.1 ../../Config ../../BusPlugin_Zookpeer
do_work RouteServer 15.100.7.1 ../../Config ../../BusPlugin_Zookpeer
do_work RouteAgentServer 15.100.6.1 ../../Config ../../BusPlugin_Zookpeer
do_work StoreServer 15.100.8.1 ../../Config ../../BusPlugin_Zookpeer
do_work LoginServer 15.100.2.1 ../../Config ../../BusPlugin_Zookpeer
do_work WorldServer 15.100.3.1 ../../Config ../../BusPlugin_Zookpeer
do_work LogicServer 15.100.10.1 ../../Config ../../BusPlugin_Zookpeer
do_work ProxyServer 15.100.5.1 ../../Config ../../BusPlugin_Zookpeer
do_work ProxyAgentServer 15.100.13.1 ../../Config ../../BusPlugin_Zookpeer
