...
public:
    ...
    // @param[in] body -
    // @return  -
    Request(ConnPool* pool, EventLoop* loop, const std::string& http_uri, const std::string& body);
    ...
    // @param[in] timeout -
    // @return -
    Request(EventLoop* loop);

    ~Request();

    int Init(const std::string& http_url, const std::string& body);

    int Init(const std::string& http_url, const std::string& body, Duration timeout);
