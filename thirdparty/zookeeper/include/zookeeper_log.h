...
#ifndef THIRDPARTY_ZOOKEEPER_INCLUDE_ZOOKEEPER_LOG_H_
#define THIRDPARTY_ZOOKEEPER_INCLUDE_ZOOKEEPER_LOG_H_
...
#endif  // THIRDPARTY_ZOOKEEPER_INCLUDE_ZOOKEEPER_LOG_H_
